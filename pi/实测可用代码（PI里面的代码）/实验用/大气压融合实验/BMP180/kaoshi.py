...
def getValue(name, value):
    ...
    while LED_OPENED:
        ...
        if shidu != None:
            # send_data = {"s":shidu}
            send_data = {"t":temperature, "h":humidity,"s":shidu,"g":guangzhao,"Temp":Temp,"Pressure":Pressure,"Altitude":Altitude,"Sealevel_Pressure":Sealevel_Pressure,"rade_data":Sealevel_Pressure}
